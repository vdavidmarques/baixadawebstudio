...
/*******************************
    ...
    ********************************/
        ...
        ********************************/
        ...
        function linked_url() {
            $post_id = '11';
            add_menu_page('linked_url','Informações Gerais','read','post.php?post='. $post_id . '&action=edit','', 'dashicons-admin-generic',  90);
        }
...
/*******************************
    ...
    ********************************/
        ...
        ********************************/
        ...
        add_action('admin_menu', 'linked_url');
        function linked_url() {
            add_menu_page('linked_url','Informações Gerais','read','post.php?post=298&action=edit','', 'dashicons-admin-generic',  90);
        }
        ...
        ********************************/
        ...
        function exclude_pages_from_admin($query){
            global $pagenow,$post_type;
            if(is_admin() && $pagenow == 'edit.php' && $post_type == 'page') {
                $settings_page = get_page_by_path('informacoes-gerais-2', NULL,'page')->ID;
                $query->query_vars['post__not_in'] = array($settings_page);
            }
