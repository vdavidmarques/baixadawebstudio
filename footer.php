...
<footer role="contentinfo" itemscope itemtype="https://schema.org/WPFooter">
    <div class="container">
        <div class="about-me-footer" id="quem-somos" itemscope itemtype="https://schema.org/LocalBusiness">
            ...
            <div class="form">
                <?php include $_SERVER['DOCUMENT_ROOT'] . $root . '/components/form.php'; ?>
            </div>
        </div>
        ...
        <button class="scroll-to-top-btn" id="scrollToTopBtn">Subir para o topo</button>
    </div>
    <div class="after-footer-bg">
        <div class="container after-footer">
            <div id="copyright" itemprop="copyrightYear"> &copy; 2024 Baixada Web Studio - CNPJ: 38.131.123/0001-34 </div>
        </div>
    </div>
</footer>
</main>
